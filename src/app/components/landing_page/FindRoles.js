  ...
  return (
    <div className="container mt-[30px] 2m:mt-[50px]">
      <h2 className="text-[35px] 2sm:text-[40px] font-semibold leading-[48px] tracking-[-0.04em]">
        Your Professional Odyssey Starts Here
      </h2>
      ...
      <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-[20px] mt-[40px]">
        ...
        <div className="basis-[70%] 2xl:basis-[50%]">
          <h4 className="text-[35px] 2sm:text-[40px] font-semibold leading-[48px] tracking-[-0.04em]">
            Never Miss a Beat: Get trending and latest updates for Casting
            Calls, Industry News, and Gig Opportunities{" "}
          </h4>
          <p className="text-lg font-normal leading-[30px] tracking-normal">
            Never Miss an Opportunity: Get Real-Time Casting Calls & Gigs Stay
            Informed: Industry News & Trends to Enhance Your Career Expert
            Advice & Resources: Elevate Your Skills & Network
          </p>
        </div>
      </div>
