...
const Page = () => {
  ...
  return (
    <div className="container py-[35px]">
      <div className="flex justify-center m-auto h-[559px] max-w-[750px] 2xl:max-w-[1000px] w-auto">
        <div className="basis-[50%] bg-[url('/loginPic.svg')] bg-no-repeat bg-cover"></div>
        {!otpPage ? (
